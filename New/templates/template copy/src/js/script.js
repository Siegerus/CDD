...
// // 	window.addEventListener("load", () => item.scrollIntoView());
// // }
// // scrollDown();
...
// // let li = document.querySelectorAll("body > ul > li")
// // let data = [];

// // while(true) {
// // 	let answer = prompt("enter smth", "");
// // 	if(answer) data.push(answer);

// // 	li.forEach((item, i) => {
// // 		if(!data[i]) item.innerHTML = "";
// // 		else item.innerHTML = data[i];
// // 	});
...
// 	let circlee = document.querySelector(".circlee");
// -
// 	function showCircle(cx, cy, radius) {
// 		circlee.style.visibility = "visible";
// 		circlee.style.top = cy + scrollY + "px";
// 		circlee.style.left = cx + "px";
// 		circlee.style.width = radius + "px";
// 		circlee.style.height = radius + "px";
// 		circlee.style.lineHeight = radius + "px";
		
// 		circlee.ontransitionend = () => circlee.innerHTML = cx + " " + cy + " " + radius;
// 	}

// 	document.addEventListener("dblclick", () => showCircle(240, 100, 130));


/* let circle = document.querySelector(".circle");

function showCircle(cx, cy, radius, callback) {
	circle.style.top = cy + scrollY + "px";
	circle.style.left = cx + "px";
	circle.style.width = radius + "px";
	circle.style.height = radius + "px";
	circle.addEventListener("transitionend", (e) => callback("transitionend"))
}

document.addEventListener("keydown", (e) => {
	if(e.key == "q") showCircle(150, 150, 200, function(text) {
		console.log(text);
	});
}); */
